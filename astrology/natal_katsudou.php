...
for ($i = 1; $i <= 5; $i++)
{
  imageline($im, $margins, $cell_height*$i, $margins+$cell_width*10, $cell_height*$i, $black);
}
//縦線
for ($i = 0; $i <= 3; $i++)
{
  imageline($im, $margins+$cell_width*$i*3, $cell_height, $margins+$cell_width*$i*3, $cell_height*5, $black);
}
